...
export class ProfileManagement {
    ...
    public static async createNewProfile(formResponse: imperative.IProfile) {
        await ProfileManagement.ProfilesCache.getProfileLoaded("cics", "cics", formResponse);
        await ProfileManagement.getExplorerApis().getExplorerExtenderApi().reloadProfiles();
    }

    public static async updateProfile(formResponse: imperative.IProfile) {
        const profile: imperative.IProfileLoaded = await ProfileManagement.ProfilesCache.getProfileLoaded("cics", "cics", formResponse);
        await ProfileManagement.getExplorerApis().getExplorerExtenderApi().reloadProfiles();
        return profile;
    }

    public static async deleteProfile(formResponse: imperative.IProfile) {
        await ProfileManagement.ProfilesCache.getProfileLoaded("cics", "cics", formResponse);
        await ProfileManagement.getExplorerApis().getExplorerExtenderApi().reloadProfiles();
    }
